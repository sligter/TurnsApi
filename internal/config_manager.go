...
func fromDBUserGroup(dbGroup *database.UserGroup) *UserGroup {
	return &UserGroup{
		...
		DisablePermanentBan: dbGroup.DisablePermanentBan,
		MaxErrorCount:       dbGroup.MaxErrorCount,
		RateLimitCooldown:   dbGroup.RateLimitCooldown,
	}
}
